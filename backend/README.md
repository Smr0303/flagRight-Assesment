...
<p align='center'>
<b>A Transaction Management CRUD API for flagright intern assignment</b>
</p>
<p align='center'>
...
<p align='center'>
This is the backend of the project built with Nodejs and Supabase and deployed with <a href='https://www.netlify.com/' target='_blank'>Render</a>
</p>
...
## 🚀 Link to [Frontend](https://github.com/varunKT001/tomper-wear-ecommerce-backend)

## 📷 Link to [Screenshots](./SCREENSHOTS.md)

## 🧾 Description

a Transaction Management CRUD API with user authentication and authorization for role based access. Admins have the right to create 
