...
const generateRandomData = {
  ...
  ipAddress: () => {
    return `${generateRandomData.randomNumber(
      1,
      255
    )}.${generateRandomData.randomNumber(
      1,
      255
    )}.${generateRandomData.randomNumber(
      1,
      255
    )}.${generateRandomData.randomNumber(1, 255)}`;
  },
  ...
  email: () => {
    ...
    return `${generateRandomData.randomArrayElement(
      usernames
    )}${generateRandomData.randomNumber(
      1,
      999
    )}@${generateRandomData.randomArrayElement(domains)}`;
  },
  ...
  sentence: () => {
    ...
    const length = generateRandomData.randomNumber(2, 7);
    return Array.from({ length }, () =>
      generateRandomData.randomArrayElement(words)
    ).join(" ");
  },
};
...
const generateRandomTransaction = () => {
  const obj = {
    ...
    p_type: generateRandomData.randomArrayElement([
      "Deposit",
      "Withdrawals",
      "Transfers",
      "Payments",
    ...
    p_origindevicedata: {
      ...
      operatingSystem: generateRandomData.randomArrayElement([
        "Android",
        "iOS",
        "Windows",
        "Linux",
      ]),
      deviceMaker: generateRandomData.randomArrayElement([
        "Apple",
        "Samsung",
        "Google",
        "Huawei",
      ...
      deviceModel: generateRandomData.randomArrayElement([
        "ProModel",
        "EliteBook",
        "Galaxy",
        "Pixel",
      ...
      appVersion: `${generateRandomData.randomNumber(
        1,
        5
      )}.${generateRandomData.randomNumber(
        0,
        9
      )}.${generateRandomData.randomNumber(0, 9)}`,
    },
    ...
    p_tags: [
      {
        key: generateRandomData.randomArrayElement([
          "category",
          "source",
          "type",
        ]),
        value: generateRandomData.randomArrayElement([
          "online",
          "mobile",
          "transfer",
        ]),
